...
class YoutubeVideoTest extends PHPUnit_Framework_TestCase
{
    public function testYoutubeVideoInitialState()
    {
        ...
        $this->assertNull($video->video_id, '"video_id" should initially be null');
    ...
    public function testExchangeArraySetsPropertiesCorrectly()
    {
        ...
        $this->assertSame($data['video_id'], $video->video_id, '"" was not set correctly');
    ...
    public function testExchangeArraySetsPropertiesToDefaultIfKeysAreNotPresent()
    {
        ...
        $this->assertNull($video->video_id, '"video_id" should have defaulted to null');
